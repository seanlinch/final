...
export default class App extends React.Component {
  ...
  getIdeas() {
    ...
    let airtableUrl = "https://api.airtable.com/v0/appcHbzra18TOUHEL/ideas?&view=Grid%20view";
  ...
  upvoteIdea(data, secId, rowId, rowMap) {
    ...
    let requestOptions = { 
      method: 'PATCH',
      headers: new Headers({
        'Authorization': 'Bearer keyV4oqFP1aJ9oo7R', // replace with your own API key
